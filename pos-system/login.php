    ...
    <div class="login-grid">
        <section class="login-hero d-flex flex-column justify-content-between">
            <div>
                ...
                <p class="lead mb-0" style="opacity:.88">A single workspace for daily sales, stock control, purchasing, finance, and people operations.</p>
            </div>
        ...
        <section class="login-form">
            ...
            <div class="mt-4 pt-3 border-top">
                <div class="d-flex align-items-start gap-2 text-muted small">
                    ...
                    <span>Development seed: <strong>admin / admin123</strong>. Change the password before real deployment.</span>
                </div>
            </div>
        </section>
    </div>
