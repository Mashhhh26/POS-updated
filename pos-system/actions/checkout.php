...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // ============================================
    $subtotal_original = 0;
    $vatable_total = 0;      // V - may VAT
    $vat_exempt_total = 0;   // E - walang VAT
    $vat_zero_total = 0;     // Z - 0% VAT
    
    // Get product VAT types from database
    ...
    // Compute VAT (12% of VATable)
    $vat = $vatable_total * 0.12;
    $subtotal_selling = $subtotal_original + $vat;
    
    // Senior discount (20% of total with VAT)
    $discount = 0;
    $discount_type = 'none';
    ...
    try {
        ...
        // Insert sale - with VAT breakdown
