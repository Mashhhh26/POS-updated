                    ...
                    <form method="POST" action="">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="department" class="form-select" required><option value="">Select department</option><?php foreach(["IT","HR","Finance","Operations","Sales","Marketing","Procurement","Warehouse"] as $d): ?><option value="<?php echo h($d); ?>"><?php echo h($d); ?></option><?php endforeach; ?></select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Cost Centre <span class="text-danger">*</span></label>
                                <select name="cost_centre" class="form-select" required><option value="">Select cost centre</option><?php foreach(["CC-IT","CC-HR","CC-FIN","CC-OPS","CC-SALES","CC-MKT","CC-PROC","CC-WH"] as $c): ?><option value="<?php echo h($c); ?>"><?php echo h($c); ?></option><?php endforeach; ?></select>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <div id="items-container">
                                    <div class="row g-2 item-row">
                                        ...
                                        <div class="col-2">
                                            <select name="items[0][unit]" class="form-select"><option value="pcs">pcs</option><option value="unit">unit</option><option value="box">box</option><option value="set">set</option><option value="pack">pack</option></select>
                                        </div>
                                        <div class="col-3">
    ...
    <script>
        ...
        function addItemRow() {
            ...
            row.innerHTML = `
                ...
                <div class="col-2">
                    <select name="items[${itemIndex}][unit]" class="form-select"><option value="pcs">pcs</option><option value="unit">unit</option><option value="box">box</option><option value="set">set</option><option value="pack">pack</option></select>
                </div>
                <div class="col-3">
