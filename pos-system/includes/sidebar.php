...
<div class="sidebar bg-white shadow-sm p-3" style="min-height: calc(100vh - 56px); width: 250px; flex-shrink: 0; overflow-y: auto;">
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link <?php echo $current_page == 'users.php' ? 'active bg-primary text-white' : 'text-dark'; ?>" href="<?php echo BASE_PATH; ?>modules/users.php"><i class="fas fa-user-shield me-2"></i> User Accounts</a></li>
        <?php endif; ?>
        <?php endif; ?>
