...
function verify_csrf():void{if($_SERVER['REQUEST_METHOD']!=='POST')return;$t=$_POST['csrf_token']??'';if(!hash_equals($_SESSION['csrf_token']??'',$t)){http_response_code(419);exit('Invalid or expired security token.');}}
