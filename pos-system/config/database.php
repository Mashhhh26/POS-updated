...
function getDB() {
    try {
        $conn = new PDO("mysql:host=".DB_HOST.";dbname=".DB_NAME.";charset=utf8mb4", DB_USER, DB_PASS, [PDO::ATTR_EMULATE_PREPARES=>false]);
...
function hasPermission($permission) {
    if ((int)($_SESSION['role_id'] ?? 0) === 1 || (($_SESSION['role'] ?? '') === 'Admin')) return true;
    return isset($_SESSION['permissions']) && is_array($_SESSION['permissions']) && in_array($permission, $_SESSION['permissions'], true);
}
